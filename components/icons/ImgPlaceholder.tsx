...
interface ImgPlaceholder {
  className?: string;
  colors?: string;
}

const ImgPlaceholder: React.FC<ImgPlaceholder> = ({ className, colors }) => {
  return (
    <svg className={className} style={{fill : colors}} xmlns="http://www.w3.org/2000/svg">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
